...
import { apiLoginCafe } from "@/lib/api-requests";
...
export default function Login() {
  ...
  const methods = useForm<LoginCafeInput>({
    resolver: zodResolver(LoginCafeSchema),
  });
  ...
  async function LoginCafeFunction(credentials: LoginCafeInput) {
  ...
  const onSubmitHandler: SubmitHandler<LoginCafeInput> = (values) => {
    console.log(values);
    LoginCafeFunction(values);
  };
